...
public class CategoryService :ICategoryService
{
    ...
    {
        var existCategory = await this.repository.GetAsync(c => c.Id.Equals(dto.Id), includes: new[] { "Products", "Variations" })
    ...
    {
        var categories = await this.repository.GetAll(includes: new[] { "Products", "Variations" }).ToListAsync();
